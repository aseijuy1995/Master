...
public class ImageTask extends AsyncTask<Object, Integer, Bitmap> {
    ...
    private String url;
    private int photo_id, imageSize;
    ...
    public ImageTask(String url, int photo_id, int imageSize, ImageView imageView) {
        this.url = url;
    ...
    protected void onPostExecute(Bitmap bitmap) {
        ...
        if (bitmap != null) {
            ...
            imageView.setImageResource(R.drawable.account_bulldog);
        }
    }
