...
public class GetPostImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private String url;
    private int post_id, imageSize;
    private WeakReference<ImageView> imageViewWeakReference;
    private final static String TAG = "GetPostImageTask";


    public GetPostImageTask(String url, int post_id, int imageSize, ImageView imageView) {
        this.url = url;
